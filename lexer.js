export class Lexer {
    ...
    expectToken(expected) {
        ...
        if (!token || (!isArr && token.value !== expected) || (isArr && !expected.includes(token.value))) {
